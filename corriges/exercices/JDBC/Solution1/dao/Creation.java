...
public class Creation implements IConstantes {
    ...
    private static void tableClients() {
        ...
        try {
            ...
            System.out.println("Creation de la table " + NOM_TABLE_C + " si elle n'existe pas.");
            stmt.executeUpdate(strC);
        }
        catch (Exception e) {
            System.out.println("Erreur a la creation de la table " + NOM_TABLE_C + " : ");
            System.out.println(e);
        }
    }
    ...
    private static void tableFournisseurs() {
        ...
        try {
            ...
            System.out.println("Creation de la table " + NOM_TABLE_F + " si elle n'existe pas.");
            stmt.executeUpdate(strF);
        }
        catch (Exception e) {
            System.out.println("Erreur a la creation de la table " + NOM_TABLE_F + " : ");
            System.out.println(e);
        }
    }
    ...
    private static void tableArticles() {
        String strA = "CREATE TABLE IF NOT EXISTS " + NOM_TABLE_A + " ("
            + "id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, "
            + "numero INT(10) NOT NULL UNIQUE, "
        ...
        try {
            ...
            System.out.println("Creation de la table " + NOM_TABLE_A + " si elle n'existe pas.");
            stmt.executeUpdate(strA);
        }
        catch (Exception e) {
            System.out.println("Erreur à la creation de la table " + NOM_TABLE_A + " : ");
            System.out.println(e);
        }
    }
}